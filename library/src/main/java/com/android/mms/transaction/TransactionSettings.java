...
//            Log.e(TAG, "Apn is not found in Database!");
        ...
        mServiceCenter = NetworkAddressUtils.trimV4AddrZeros(Transaction.settings.getMmsc());
        mProxyAddress = NetworkAddressUtils.trimV4AddrZeros(Transaction.settings.getProxy());
